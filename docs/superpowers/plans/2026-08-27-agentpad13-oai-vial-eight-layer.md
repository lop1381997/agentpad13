...
- [x] **Step 1: Write a static target contract test**
...
- [x] **Step 2: Run the static contract test to verify it fails**
...
- [x] **Step 3: Add a host C harness for Vial dispatch**
...
- [x] **Step 4: Run the harness test to verify it fails**
...
- [x] **Step 1: Extend the failing test with the exact layer defaults**
...
- [x] **Step 2: Run the layer test to verify it fails**
...
- [x] **Step 3: Implement the target configuration and Vial definition**
...
- [x] **Step 4: Implement the eight default maps and dynamic encoder defaults**
...
- [x] **Step 5: Run target contract tests to verify they pass**

Run: `python3 -m unittest firmware.tests.codex_oai.test_vial_oai_contract.VialOaiLayoutTest -v`

Expected: PASS; the direct-OAI tests still remain unchanged and passing.

- [x] **Step 6: Commit the Vial target**
...
- [x] **Step 1: Extend the test for exact framing and Vial ownership**
...
- [x] **Step 2: Run transport tests to verify they fail**

Run: `python3 -m unittest firmware.tests.codex_oai.test_vial_oai_contract.VialOaiProtocolTest -v`

Expected: FAIL because Direct OAI still requires 64 bytes, report ID 6 and owns `raw_hid_receive()`.

- [x] **Step 3: Implement selectable frame transport and fragmentation**
...
- [x] **Step 4: Dispatch only OAI-prefixed Vial frames**
...
- [x] **Step 5: Route dynamic Vial keycodes without OAI EEPROM writes**
...
- [x] **Step 6: Run the transport and Direct OAI regression tests**
...
- [x] **Step 7: Commit the transport integration**
...
- [x] **Step 2: Run release assertions to verify they fail**
...
- [x] **Step 3: Extend the safe build tool**
...
- [x] **Step 4: Implement emulator coexistence evidence**
...
- [x] **Step 5: Build and run all required verification**
...
- [x] **Step 6: Document installation and host transport migration**
