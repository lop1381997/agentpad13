...
#define CODEX_LAYER_INDICATOR_LED 13U
...
#define CODEX_LAYER_TRANSITION_TOTAL_MS \
    (CODEX_LAYER_TRANSITION_FADE_IN_MS + CODEX_LAYER_TRANSITION_HOLD_MS + CODEX_LAYER_TRANSITION_FADE_OUT_MS)
